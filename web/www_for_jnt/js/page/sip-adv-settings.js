...
(function(){
	...
	$("#lang_stun_switch").html(language('STUN Switch'));
	$("#lang_stun_switch_help").html(language('STUN Switch help','STUN Switch'));
...
function show_sip_settings(data_temp){
	...
	var stun_server_sw = stun_data['_serverstunsw'] == 1 ? true : false
	var stun_client_sw = stun_data['_clientstunsw'] == 1 ? true : false
	var stun_none_sw = stun_data['_nonestunsw'] == 1 ? true : false
	...
	document.getElementById('server_stunsw').checked = stun_server_sw
	document.getElementById('client_stunsw').checked = stun_client_sw
	document.getElementById('none_stunsw').checked = stun_none_sw
	/* Networking STUN Settings end */
...
function save_sip_setttings(sip_data){
	...
	var stun_server_sw = document.getElementById('server_stunsw').checked == true ? 1 : 0
	SipAdvStun._serverstunsw = stun_server_sw
	
	var stun_server_sw = document.getElementById('client_stunsw').checked == true ? 1 : 0
	SipAdvStun._clientstunsw = stun_server_sw
	
	var stun_server_sw = document.getElementById('none_stunsw').checked == true ? 1 : 0
	SipAdvStun._nonestunsw = stun_server_sw
