...
/***************************************************************************/
(function(){
	$("#lang_fxs_settings").html(language('FXS settings'));
	...
	$("#lang_offhook_antishake_help").html(language('offhook-antishake help', 'The anti-jitter delay value when the gateway FXS port detects the off-hook signal. The setting value is from 32ms to 2048ms (multiple of 32) and the default value is 64ms. <br/>'));
