...
(function(){
	...
	$("#lang_fxs_rx_gain").html(language('FXS Rx gain'));
	$("#lang_fxs_rx_gain_help").html(language('FXS Rx gain help','Set FXS to terminal gain. Range: -35, 0 or 35. the default is 0. <br/>'));
	$("#lang_fxs_tx_gain").html(language('FXS Tx gain'));
	$("#lang_fxs_tx_gain_help").html(language('FXS Tx gain help','Set FXS to IP gain. Range: -35, 0 or 35. the default is 0. <br/>'));
	/* Hardware gain end */
